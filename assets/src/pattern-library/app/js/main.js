  ...
  methods: {
    ...
    */
    updateActive: function () {
      ...
      if (_this.$root && _this.$root.scroll_position >= _this.$el.offsetTop - 60 && _this.$root.scroll_position < _this.$el.offsetTop + _this.$el.offsetHeight) {
    ...
    setHideSample: function (callback) {
      ...
      setTimeout(function () {
        if (_this.$el.querySelector('.ndpl-component__code')) {
          ...
          */
          if (_this.component.options.disabled_auto_sample_hiding && _this.component.options.disabled_auto_sample_hiding.hasOwnProperty('show_on_mobile') && _this.component.options.disabled_auto_sample_hiding.hasOwnProperty('show_on_desktop')) {
  ...
  methods: {
    ...
    */
    loadGroup: function (group) {
      ...
      _this.$http.get(group_path + '/description.md' + '?cb=' + new Date()).then(
        function (response) {
    ...
    */
    loadComponent: function (component) {
      ...
      _this.$http.get(component_path + '/markup.html' + '?cb=' + new Date()).then(
        function (response) {
      ...
      // Get and set component description
      _this.$http.get(component_path + '/description.md' + '?cb=' + new Date()).then(
        function (response) {
